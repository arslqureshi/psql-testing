...
const WarehouseController = {
    ...
    edit(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (data.rows[0]) {
                    const query = yield db_1.default.query('UPDATE warehouses SET city=$1, address=$2, details=$3, price=$4, ownerId=$5, lat=$6, lat=$7   WHERE id=$8', [userData.city, userData.address, userData.details, userData.price, userData.ownerId, userData.lat, userData.lat]);
                    res.send(query);
                }
                else {
    ...
    deleteById(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const query = yield db_1.default.query('DELETE FROM warehouses WHERE id=$1', [id]);
                res.send(query);
            }
            catch (e) {
                console.log(e.message);
    ...
    getAll(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const query = yield db_1.default.query(`SELECT * FROM warehouses`);
                res.send(query.rows);
            }
            catch (e) {
                console.log(e.message);
