...
const StripeController = {
    ...
    async createPrice(data) {
        const price = await stripe.prices.create(data);         //accepts an object
        return price;
    },
    ...
    async updateProduct(id, data) {
        const product = await stripe.products.update(id, data); //accepts id followed by object containing new data  
        return product;  
    },
    async updatePrice(id, data) {
        const price = await stripe.prices.update(id, data); //accepts id followed by object containing new data    
        return price;
    }
}
